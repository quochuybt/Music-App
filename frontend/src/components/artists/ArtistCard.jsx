...
export default function ArtistCard({ artist }) {
  return (
    <Link to={`/artists/${artist.id}`} className="group w-64 shrink-0 snap-start rounded-2xl bg-white/[0.04] p-5 text-center ring-1 ring-white/10 transition duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:-translate-y-1 hover:bg-white/[0.07] sm:w-auto sm:shrink">
